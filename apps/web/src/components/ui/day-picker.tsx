...
import { buttonVariants, cn } from '@harness/ui';
import { ChevronLeft, ChevronRight } from 'lucide-react';
import { getDefaultClassNames, DayPicker as ReactDayPicker } from 'react-day-picker';
  ...
  return (
    <ReactDayPicker
      ...
      classNames={{
        ...
        weekday: cn('text-muted-foreground w-9 font-normal text-[0.8rem]', defaultClassNames.weekday),
