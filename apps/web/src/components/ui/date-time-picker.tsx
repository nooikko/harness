...
import { useCalendar } from '@/app/(chat)/calendar/_components/calendar-context';
import type { TEventFormData } from '@/app/(chat)/calendar/_helpers/event-schema';
                ...
                <div className='flex sm:flex-col p-2'>
                  {Array.from({ length: use24HourFormat ? 24 : 12 }, (_, i) => i).map((hour) => (
                    <Button
                      ...
                      size='icon'
                      variant={
                        field.value && field.value.getHours() % (use24HourFormat ? 24 : 12) === hour % (use24HourFormat ? 24 : 12)
                          ? 'default'
                          : 'ghost'
                      }
