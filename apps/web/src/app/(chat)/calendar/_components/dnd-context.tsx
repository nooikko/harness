...
type DndProviderComponent = (props: DndProviderProps) => React.ReactNode;

export const DndProvider: DndProviderComponent = ({ children }) => {
...
type UseDragDrop = () => DragDropContextType;
