...
const eventBadgeVariants = cva(
  'flex w-full h-6.5 select-none items-center justify-between gap-1.5 truncate whitespace-nowrap rounded-sm border px-2 text-xs cursor-grab',
  {
    variants: {
      color: {
        // Colored variants
...
type MonthEventBadgeComponent = (props: IProps) => React.ReactNode;

export const MonthEventBadge: MonthEventBadgeComponent = ({
  event,
  cellDate,
  eventCurrentDay,
  eventTotalDays,
