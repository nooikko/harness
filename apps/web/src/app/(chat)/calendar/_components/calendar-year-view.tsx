...
import { getCalendarCells } from '../_helpers/calendar-helpers';
...
type CalendarYearViewComponent = (props: IProps) => React.ReactNode;

export const CalendarYearView: CalendarYearViewComponent = ({ singleDayEvents, multiDayEvents }) => {
