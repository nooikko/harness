...
import { getEventsCount, navigateDate, rangeText } from '../_helpers/calendar-helpers';
...
type DateNavigatorComponent = (props: IProps) => React.ReactNode;

export const DateNavigator: DateNavigatorComponent = ({ view, events }) => {
