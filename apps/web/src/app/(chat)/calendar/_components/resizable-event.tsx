...
type ResizableEventComponent = (props: ResizableEventBlockProps) => React.ReactNode;

export const ResizableEvent: ResizableEventComponent = ({ event, children, className }) => {
