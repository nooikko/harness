import { Avatar, AvatarFallback, AvatarImage, Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, cn } from '@harness/ui';
import { format, parseISO } from 'date-fns';
import type { FC } from 'react';
import { formatTime, getBgColor, getColorClass, getEventsForMonth, getFirstLetters, toCapitalize } from '../_helpers/calendar-helpers';
                  ...
                  <div className='w-full flex items-center justify-between gap-4'>
                    <div className='flex items-center gap-2'>
                      ...
                      <div className='flex flex-col'>
                        ...
                        <p className='text-muted-foreground text-sm line-clamp-1 text-ellipsis md:text-clip w-1/3'>{event.description}</p>
                      </div>
                    </div>
