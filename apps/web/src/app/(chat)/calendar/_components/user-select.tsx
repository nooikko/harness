import { Avatar, AvatarFallback, AvatarGroup, AvatarImage, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@harness/ui';
import { useCalendar } from './calendar-context';

type UserSelectComponent = () => React.ReactNode;
