...
import { Badge, Button, cn } from '@harness/ui';
import { BookmarkPlus, Check, Flag, Plus } from 'lucide-react';
          ...
          <div className='flex items-center gap-0 px-2'>
            {transcripts.map((t) => (
              <button
                ...
                type='button'
                className={cn(
                  'shrink-0 px-3 py-1.5 text-xs border-b-2 transition-colors',
                  activeTab === t.id
                ...
                >
                  ...
                  >
                    ...
                    <div className='shrink-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-start gap-0.5 pt-0.5'>
                      <button type='button' className='p-1 rounded hover:bg-muted text-muted-foreground' title='Add note'>
                        <BookmarkPlus className='h-3 w-3' />
                      </button>
                      <button type='button' className='p-1 rounded hover:bg-muted text-muted-foreground' title='Flag important'>
